 ...
 * output class name
 */
public class SupplySyncLogListUI extends AbstractSupplySyncLogListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SupplySyncLogListUI.class);
    
    /**
     * output class constructor
     */
    public SupplySyncLogListUI() throws Exception
    {
        super();
    }
